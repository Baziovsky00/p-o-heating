...
const links = [
    ...
    {
        title: 'Radiator Installations & Repairs',
        ...
        <footer style={{ backgroundColor: 'rgb(255, 102, 42)' }} className="bg-muted py-16 border-t border-muted-foreground/10">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <Image src={'/images/logo.svg'} width={53} height={53} alt='P O heating services' />
                </Link>
                ...
                <span className="text-white block text-center text-sm"> © {new Date().getFullYear()} P O heating, All rights reserved</span>
            </div>
        </footer>
    )
}
